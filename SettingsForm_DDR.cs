...
namespace DDRplugin
{
    internal partial class SettingsForm_DDRplugin : Form
    {
        ...
        public SettingsForm_DDRplugin(string InputFile, string SelectedEncodingIncoming, int VecSize, int VocSize, string[] WordList)
        {
            InitializeComponent();
